...
// Converts a vector of strings to a vector of unsigned integers with stoul.
vector<unsigned int> vecStrToUInt(const vector<string> &strs) {
	vector<unsigned int> nums;
	for (string str : strs) {
		nums.push_back(stoul(str));
	}
	return nums;
}
